    ...
    <table border="1">
        ...
        <tr>
            ...
            <td rowspan="6">
                <table>
                    <tr>
                        <td><a href="../view/registration-employee.php">Add Employee</a></td>
                        
                    </tr>
                    <tr>
                        <td><a href="../view/employee_list.php">Show Employee</a></td>
                    </tr>
                    <tr><td><a href="../view/employee_edit.php">Edit Employee</a></td></tr>
